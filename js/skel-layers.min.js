...
(function(e) {
    ...
    var n = "config",
        ...
        z = "length",
        W = "visible",
        X = "touchstart.lock click.lock scroll.lock",
        V = '<div id="skel-layers-placeholder-',
        $ = "resetForms",
        J = !0,
        K = "-webkit-",
        Q = "recalcW",
        G = "padding-bottom",
        Y = "skel-layers-exclusiveVisible",
        Z = "isInitialized",
        et = "originalEvent",
        tt = "animation",
        ...
        ot = "skel-layers-layer-index",
        ut = "#skel-layers-placeholder-",
        at = "skel_layers_hiddenWrapper",
        ft = "unlockView",
        lt = "animations",
    ...
    t.registerPlugin(I, function(e) {
        function Nn(e, r, i) {
            ...
            this.id = e, this.index = i, this[n] = {
                ...
                swipeToHide: J,
                clickToHide: H
            }, t._.extend(this[n], r), this[j] = t._.newDiv(this[n][jt]), this[j].id = e, this[j]._layer = this, this[h] = x, this[St] = x, this[xt] = x, this[W] = H, o = t._.newElement(this.id, this[j], at, 1), o.onAttach = function() {
                var e = this[$t]._layer;
                e[Z]() || e.init(), e.resume()
            }, o.onDetach = function() {
                var e = this[$t]._layer;
                e.suspend()
            }, this[n].states && this[n].states != t._.sd ? (t._.cacheElement(o), s = t._[fn](this[n].states), t._[_t](s, function(e) {
                t._.addCachedElementToState(s[e], o)
            })) : this[n].breakpoints ? (t._.cacheElement(o), s = t._[fn](this[n].breakpoints), t._[_t](s, function(e) {
                t._.addCachedElementToBreakpoint(s[e], o)
            })) : t._.attachElement(o)
        }
        var t;
